...
const employeeLinks = [
  ...
  { path: '/employee/my-issues', label: 'My Issues', icon: <span role="img" aria-label="my issues">🔎</span> },
  { path: '/employee/tasks', label: 'Task Manager', icon: <span role="img" aria-label="tasks">✅</span> },
  { path: '/employee/view-polls', label: 'View Polls', icon: <span role="img" aria-label="polls">🗳️</span> },
  { path: '/employee/profile', label: 'Profile', icon: <span role="img" aria-label="profile">👤</span> },
  { path: '/employee/change-password', label: 'Change Password', icon: <span role="img" aria-label="change password">🔑</span> },
];
