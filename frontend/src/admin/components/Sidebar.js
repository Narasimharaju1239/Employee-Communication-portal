...
const adminLinks = [
  ...
  { path: '/admin/view-bookings', label: 'View Bookings', icon: <span role="img" aria-label="bookings">📅</span> },
  ...
  { path: '/admin/tasks', label: 'Task Manager', icon: <span role="img" aria-label="tasks">✅</span> },
  { path: '/admin/add-pool', label: 'Add Pool', icon: <span role="img" aria-label="add pool">🗳️</span> },
  { path: '/admin/profile', label: 'Profile', icon: <span role="img" aria-label="profile">👤</span> },
  { path: '/admin/change-password', label: 'Change Password', icon: <span role="img" aria-label="change password">🔑</span> },
];
...
const Sidebar = () => {
  return (
    <aside
      style={{
        width: SIDEBAR_WIDTH,  background: '#111',
